...
CREATE SCHEMA IF NOT EXISTS `ait` DEFAULT CHARACTER SET utf8 ;
USE `ait` ;
...
CREATE  TABLE IF NOT EXISTS `project` (
  ...
  `public_flag` TINYINT(1) NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `idx_tag1` (`name` ASC) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `dcase` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_dcase_project1_idx` (`project_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `node` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `node_label` TEXT NULL COMMENT 'D-CaseにおけるノードID' ,
