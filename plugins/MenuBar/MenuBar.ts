...
class MenuBarPlugIn extends AssureIt.ActionPlugIn {
	...
	Delegate(caseViewer: AssureIt.CaseViewer, case0: AssureIt.Case, serverApi: AssureIt.ServerAPI): boolean {
		...
		$('.node').hover(function () {
			...
			var p = node.position();
			var j = $('<div id="menu">' +
				'<a href="#" ><img id="goal" src="images/icon.png" alt="" /></a>' +
				'<a href="#" ><img id="context" src="images/icon.png" alt="" /></a>' +
				'<a href="#" ><img id="strategy" src="images/icon.png" alt="" /></a>' +
				'<a href="#" ><img id="evidence" src="images/icon.png" alt="" /></a>' +
